...
Создано для новичков, с пошаговыми инструкциями, зелёными эмодзи 🌱💚, поцелуйчиками 😘 и флакончиками духов 🧴 — для души и эстетики.
...
Type=simple
User=root
ExecStart=/root/hl-visor run-non-validator --write-trades --write-order-statuses --serve-eth-rpc
Restart=always
RestartSec=10
